...
//<file:CODE3>test_file_8.txt<file:CODE3/>
//<import:new1>test_file_1.txt<import:new1/>
//<file:CODE2>test_file_7.txt<file:CODE2/>
...
namespace ContextTest//<import:B>test_file_1.txt<import:B/>
{
    class Program
    {
        ...
        {
            Console.WriteLine("Testing extensive imports with Context."); //<file:CODE1>test_file_6.txt<file:CODE1/>
        }
